  ...
  <div class="yuan" ref="container">
    ...
    <div class="six-screen screen">
      ...
      <div class="seal yuan-descript-1">
        ...
        <p>统领释教大元国师印</p>
        <div class="popularization-description">
          <div class="lamp-item-wrap" @click="openSeal">
            <div class="lamp-item-core"></div>
            <div class="lamp-item"></div>
          </div>
          <div class="popularization-wrapper">
            <div class="close" @click="closeSeal">x</div>
            <div class="title"><span>·</span>内容来自</div>
...
const openPopularization = () => {
  gsap.to('.five-screen .popularization-wrapper', {
    x: pxToVw(50),
    scale: 1,
    opacity: 1,
    duration: 0.5
  ...
  tl.to('.five-screen .lamp-item-core', { scale: 0.6, duration: 0.1 })
      .to('.five-screen .lamp-item-core', { scale: 1, duration: 0.1 });
};
 ...
 */
const openSeal = () => {
  gsap.to('.six-screen .popularization-wrapper', {
    x: pxToVw(50),
    scale: 1,
    opacity: 1,
    duration: 0.5
  ...
  const tl = gsap.timeline();
  tl.to('.six-screen .lamp-item-core', { scale: 0.6, duration: 0.1 })
      .to('.six-screen .lamp-item-core', { scale: 1, duration: 0.1 });
};
