<template>
    <div class="sqhx-container">
        ...
        <div class="screen first-screen">
            ...
            <div class="first-screen-cloud-img-2"></div>
        </div>
        <!-- 第二幕 -->
        <div class="second-screen">
            <div class="second-screen-title">史前回响</div>
            <div class="chip-img-1"></div>
        ...
        <div class="screen third-screen">
            <div class="third-screen-cloud-img"></div>
        ...
        <div class="screen forth-screen">
            ...
            <div class="forth-scree-cloud-img"></div>
        </div>
        <!-- 第五幕 -->
        <div class="screen fifth-screen">
            ...
            <div class="fifth-screen-text-content text-font">
        ...
        <div class="screen sixth-screen">
            <div class="sixth-screen-stone-img"></div>
            <div class="sixth-screen-text-content text-font">
        ...
        <div class="seventh-screen">
            ...
            <div class="seventh-screen-text-content-1 text-font">
            ...
            <div class="seventh-screen-text-content-2 text-font">
