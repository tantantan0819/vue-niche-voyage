<template>
    ...
    <div class="new-china-container">
        ...
        <!-- 第二屏 -->
        <div class="snap-panel panel-02">
            <div class="national-flag-img"></div>
            <div class="sticker-container">
                <div class="sticker-img"></div>
                <div class="note-container">1949</div>
            </div>
        </div>
        <!-- 第三屏 -->
        <div class="snap-panel panel-03">
             <div class="text-title">雪域新章</div>
        ...
        <div class="snap-panel panel-04">
            ...
            <div class="text-container-2 text-font">
                ...
                <p class="text-content">1956年初至1957年底，四川省凉山彝族聚居区开展民主改革，彻底废除了奴隶制度；1959年，西藏进行民主改革，终于废除农奴制，这是西藏历史上最广泛、最深刻、最伟大的社会变革。</p>
            </div>
        </div>
        <!-- 第五屏 -->
        <div class="snap-panel panel-05">
            ...
            <div class="illustration illustration-title-font">
        ...
        <div class="snap-panel panel-06">
            ...
            <div class="train-forest-container">
